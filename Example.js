// Article URL: https://coderwall.com/p/vsdrug/how-to-create-an-image-slider-with-javascript
...
function slider(){
		animate({
			...
			step:function(delta){
					ul.style.left = '-' + parseInt(current * image_width + delta * image_width) + 'px'; //percent of animation * image_width, so the movement is from 0 to image_width.
				},
			callback:function(){
				current++;
